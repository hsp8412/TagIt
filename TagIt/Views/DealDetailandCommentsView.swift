...
struct DealDetailandCommentsView: View {
    @State var deal: Deal
    ...
    var body: some View {
        VStack {
            ...
            CommentThreadsView(comments: comments)
                .padding(.top)
...
#Preview {
    DealDetailandCommentsView(deal: Deal(id: "DealID", userID: "UID1", photoURL: "https://i.imgur.com/8ciNZcY.jpeg", productText: "Product Text", postText: "Post Text. Post Text. Post Text. Post Text. Post Text. Post Text.", price: 1.23, location: "Safeway", date: "2d", commentIDs: ["CommentID1", "CommentID2"], upvote: 5, downvote: 6)
    )
}
